...
async function main() {
  ...
  try {
    ...
    console.log(`🏷️ Vendor Categories: 5`)
    console.log('\n✅ Your wedding planner database now has test data!')
    console.log('\n📝 Note: Some features like budget tracking, photos, tasks, and messages')
    console.log('require the wedding_couples table structure. This seeding focused on')
    console.log('core functionality using the couples table.')
