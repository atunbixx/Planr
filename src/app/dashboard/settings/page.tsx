      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <input type="checkbox" id="task-reminders" className="h-4 w-4" defaultChecked />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <input type="checkbox" id="budget-alerts" className="h-4 w-4" defaultChecked />
          </div>
          
          <div className="flex items-center justify-between">
            <div>
              <Label htmlFor="vendor-updates" className="text-base">Vendor Updates</Label>
              <p className="text-sm text-muted-foreground">Updates from your wedding vendors</p>
            </div>
            <input type="checkbox" id="vendor-updates" className="h-4 w-4" />
          </div>
