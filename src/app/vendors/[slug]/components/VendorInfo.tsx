  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      {vendor.features.length > 0 && (
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-3">Services & Features</h3>
          ...
          <div className="flex space-x-4">
            {vendor.socialMedia.facebook && (
              <a
                ...
                className="text-blue-600 hover:text-blue-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded"
            ...
            {vendor.socialMedia.instagram && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-pink-600 hover:text-pink-700 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 rounded"
            ...
            {vendor.socialMedia.twitter && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-400 hover:text-blue-500 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 rounded"
            ...
            {vendor.socialMedia.linkedin && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-700 hover:text-blue-800 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2 rounded"
